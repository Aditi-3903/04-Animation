  ...
  return (
    <div className="z-4   flex fixed top-0 w-full items-start justify-between">
      ...
      onMouseLeave={() => {
        ...
        <div  className="relative h-full lg:px-15 px-6 flex flex-col  justify-center items-end lg:gap-1.5 gap-1 cursor-pointer">
          <div  className="  lg:w-15 w-12 lg:h-0.5 h-px bg-white  "></div>
          <div  className=" lg:w-7 w-6 lg:h-0.5 h-[1.5px] bg-white "></div>
        </div>
      </div>
    </div>
  );
